...
- 프로젝트 이름: Todolo
- 협업 플랫폼인 **Trello**를 모티브 삼아 팀별로 일정을 공유하고, 캘린더를 통해 관리 할 수 있는 업무지원 플랫폼
- **핵심 문제점** : 모티브 삼은 **Trello** 서비스는 **Kanban** 방식의 일정 관리와 개인 일정 관리가 주를 이루고 있고, 일정이 많아질수록 한눈에 보기 어려움.
- **프로젝트 목표**: **Trello**의 한계를 보완하여, **Kanban**과 캘린더 기반으로 팀별로 일정과 업무를 효율적으로 공유하고, 역할 기반의 권한 관리 등을 제공하는
  팀별 일정 공유 및 업무 지원 플랫폼을 개발.
...
<img src="README.asset/TodloERD.png">

## 6.2 유저 팀 선정 API 설계 구조 (시퀀스 다이어그램)

<img src="README.asset/Todolo 설계꾸조.png">

## 6.3 시스템 아키텍처

<img src="README.asset/2팀_Todolo.drawio.png">
